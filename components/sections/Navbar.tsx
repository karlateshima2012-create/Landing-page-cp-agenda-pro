            ...
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="hidden lg:block">
                    <a
                        ...
                        className="inline-flex items-center justify-center relative bg-brand-pink hover:bg-brand-pink/90 text-slate-950 text-[10px] sm:text-xs font-black uppercase tracking-wider px-6 md:px-8 h-12 rounded-lg transition-all active:scale-95 shadow-lg shadow-brand-pink/20 group overflow-hidden"
                    >
            ...
            {isMenuOpen && (
                <div className="lg:hidden absolute top-20 left-0 right-0 bg-slate-950 border-b border-white/10 p-8 flex flex-col gap-6 items-center text-center animate-fade-in">
                    ...
                    <a
                        ...
                        className="w-full bg-brand-pink text-slate-950 text-xs font-black uppercase tracking-wider h-14 rounded-xl flex items-center justify-center active:scale-95 shadow-lg shadow-brand-pink/20"
                    >
                        LOGIN
                    </a>
                </div>
