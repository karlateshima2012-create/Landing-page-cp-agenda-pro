...
export const Footer = () => {
    ...
    return (
        <footer className="bg-[#020408] pt-16 pb-12 px-6 relative border-t border-white/5">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-wrap gap-8 md:gap-12 mb-10 text-[11px] font-black uppercase tracking-[0.2em] text-white/50">
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-white/20 text-[9px] font-black uppercase tracking-[0.2em]">
