            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-6">
                <div className="md:col-span-3 space-y-4">
                    ...
                    <div className="flex gap-4">
                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-slate-800/50 rounded-xl flex items-center justify-center text-brand-gray hover:text-brand-pink hover:bg-slate-700/50 transition-all border border-white/5 hover:border-brand-pink/40">
                        ...
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-slate-800/50 rounded-xl flex items-center justify-center text-brand-gray hover:text-brand-blue hover:bg-slate-700/50 transition-all border border-white/5 hover:border-brand-blue/40">
