            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
                <div className="md:col-span-3 space-y-6">
                    ...
                    <div className="flex gap-4">
                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-16 h-16 bg-slate-800/50 rounded-2xl flex items-center justify-center text-brand-gray hover:text-brand-pink hover:bg-slate-700/50 transition-all border border-white/5 hover:border-brand-pink/40">
                        ...
                        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-16 h-16 bg-slate-800/50 rounded-2xl flex items-center justify-center text-brand-gray hover:text-brand-blue hover:bg-slate-700/50 transition-all border border-white/5 hover:border-brand-blue/40">
                        ...
                        <a href="https://wa.me/8109011886491" target="_blank" rel="noopener noreferrer" className="w-16 h-16 bg-slate-800/50 rounded-2xl flex items-center justify-center text-brand-gray hover:text-brand-yellow hover:bg-slate-700/50 transition-all border border-white/5 hover:border-brand-yellow/40">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-brand-gray text-base font-bold">
                        ...
                        <li className="pt-6">
                            <button
                                ...
                                className="flex items-center gap-3 text-white/30 hover:text-brand-blue transition-all group group-hover:-translate-y-1"
                            >
                                <div className="w-8 h-8 rounded-lg border border-white/10 flex items-center justify-center group-hover:border-brand-blue/40 group-hover:bg-brand-blue/10 shadow-lg transition-all">
