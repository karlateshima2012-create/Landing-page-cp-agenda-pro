...
export const FAQSection = () => {
    ...
    return (
        <section id="faq" className="pt-4 md:pt-8 pb-12 md:pb-16 bg-transparent relative w-full transition-all duration-700">
            ...
            <div className="max-w-6xl mx-auto relative z-30 px-6 md:px-16 lg:px-24 pb-24">
