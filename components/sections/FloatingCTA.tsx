    ...
    return (
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-[320px]">
            <a
                ...
                className="w-full bg-brand-blue hover:bg-brand-blue/90 text-slate-950 font-black text-xs h-12 rounded-lg shadow-[0_15px_30px_rgba(0,0,0,0.4),0_0_15px_rgba(56,182,255,0.2)] transition-all flex items-center justify-center gap-3 active:scale-95 uppercase tracking-wider"
            >
